/**
 * Auto-generated trigger file for "apaleo Inventory API" API.
 * Generated at: 2022-07-07T21:51:17.377Z
...
function processTrigger(msg, cfg, snapshot, incomingMessageHeaders, tokenData) {
  ...
  let securities = {};
    securities['oauth2'] = { token: { access_token: cfg['accessToken']} };
  ...
  return Swagger.execute(callParams).then( async (data) => {
    ...
    if(skipSnapshot){
      ...
      await dataAndSnapshot(newElement,snapshot,snapshotKey, 'created', this);
    }
  });
}
